namespace NamRider.API.NamRiderAPI.Persistence
{
    ...
    public partial class ParkingInfo
    {
        ...
        public ParkingInfo(DateTime date, bool isValidPert, bool isReportDate, decimal rayon, string type, int? number, bool? isEstimated, string descrip, string idUser)
        {
            #region Contraints
            if (rayon <= 0) throw new ArgumentException("The rayon is invalid");
            #endregion
